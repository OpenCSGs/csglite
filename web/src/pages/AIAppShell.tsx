...
const shellAppsWithModelSwitch = new Set([claudeCodeAppId, "pi", "kimi-code", "dsh"]);
const shellAppsWithWorkDirSwitch = new Set(["claude-code", "open-code", "open-code-review", "codex", "pi", "kimi-code", "dsh"]);
