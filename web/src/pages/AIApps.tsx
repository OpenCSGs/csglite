...
function canOpenAIApp(app: AIAppCatalogEntry, state: AIAppRuntimeState): boolean {
  ...
  return ["openclaw", "csgclaw", "claude-code", "open-code", "open-code-review", "codex", "pi", "kimi-code", "dsh"].includes(app.id) &&
...
function canSelectAIAppModel(app: AIAppCatalogEntry): boolean {
  return ["claude-code", "open-code", "open-code-review", "codex", "codex-app", "zcode", "pi", "kimi-code", "dsh", "openclaw", "xiaozhi"].includes(app.id);
}
